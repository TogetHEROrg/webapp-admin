  ...
  <div className="container container-login">
    <div className="row">
      <div className="card-image col s6">
        <img className="img-special" src={fundationLogo} />
      </div>
      <div className="card-image col s6">
        <img className="img-special" src={adminImage} />
      </div>
      <div className="card-image col s12">
        <h5>Aplicación del Administrador</h5>
      </div>
      <Form>
        ...
        <div className="card-action center">
          <button
            type="submit"
            className="btn btn-special waves-effect waves-light color-boton"
          >
            Ingresar
          </button>
        </div>
